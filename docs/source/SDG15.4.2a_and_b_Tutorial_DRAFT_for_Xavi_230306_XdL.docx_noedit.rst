...
The purpose of this document is to provide countries participating in
the pilot testing of SDG Indicator 1.5.4.2 detailed technical guidance
on how to compute sub-indicator a (Mountain Green Cover Index) and
sub-indicator b (Proportion of degraded mountain land), using Colombia
as a case study.

The end goal is to maximize consistency in the application of the
methodology between countries during the pilot test.
